...
* All other parameters are defined by the [Settings class](/visualization/src/app/codeCharta/core/settings/model/settings.js). 
...
[Example Data](/visualization/src/app/codeCharta/sample.json)

[JSON Schema](/visualization/src/app/codeCharta/core/data/schema.json)
